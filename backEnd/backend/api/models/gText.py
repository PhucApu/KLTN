...
class Gtext(models.Model):
    ...
    ConcS = models.CharField(max_length=255, blank=True, null=True)  # Concept Subject
    Relation = models.CharField(max_length=255, blank=True, null=True)  # Quan hệ
    ConcO = models.CharField(max_length=255, blank=True, null=True)  # Concept Object
