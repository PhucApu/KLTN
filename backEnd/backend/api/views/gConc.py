    ...
    with transaction.atomic():
        try:
            for conceleItem in conceleLstItem:
                ...
                if item:
                    item.lstConC.append(conceleItem.conC.lower() if conceleItem.conC else "")
                    ...
                    kwargs = {
                        ...
                        'lstConC': [conceleItem.conC.lower() if conceleItem.conC else ""],
...
def get_gconc_list(request):
    ...
    for item in queryset:
            results.append({
                ...
                "lstConc": list(dict.fromkeys(item.lstConC)),
