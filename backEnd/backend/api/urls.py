...
from api.views.gConc import suggest_gconc,get_gconc_list,update_gconc,init_gConc, update_similar_conc,create_gconc
from api.views.gRel import suggest_gRel2, init_gRel,search_grel,update_grel, update_similar_rel,create_grel
...
urlpatterns = [
    ...
    path('create-gconc/', create_gconc, name='create_gconc'),
    path('create-grel/', create_grel, name='create_grel'),
